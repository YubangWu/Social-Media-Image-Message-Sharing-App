...
export const getMyPosts = async () => {
  console.log('log', auth.currentUser) // firebase.auth().currentUser
  const querySnapshot = await firestoreDb.collection('posts')
  .where("userId", "==", auth.currentUser.uid ) // firebase.auth().currentUser.uid
  .get();
